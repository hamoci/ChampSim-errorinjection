#!/usr/bin/env python3
"""
LLC Not Cache Pinned IPC Comparison Script
...
RESULTS_DIR = os.path.join(BASE_DIR, "results/not_cache_pinned")
SPEC_DIR = os.path.join(RESULTS_DIR, "SPEC_not_cache_pinned/_32gb")
GAP_DIR = os.path.join(RESULTS_DIR, "gaps_not_cache_pinned/_32gb")
...
def extract_workload_name(filename, suite):
    ...
    # Pattern: champsim_{pagesize}_error_32gb_{errorrate}_{workload}.txt
    if suite == "spec":
...
def main():
    ...
    csv_path = os.path.join(OUTPUT_DIR, "llc_notpin_ipc_comparison.csv")
    ...
    # Save plot
    png_path = os.path.join(OUTPUT_DIR, "llc_notpin_ipc_comparison.png")
