#!/usr/bin/env python3
"""IPC comparison across MTBCE for cache-pinning runs (real_final_spec)."""
...
OUTPUT_CSV = os.path.join(SCRIPT_DIR, "llc_pin_ipc_comparison.csv")
OUTPUT_PNG = os.path.join(SCRIPT_DIR, "llc_pin_ipc_comparison.png")
...
def main():
    ...
    if not workloads:
        print("No pinning records found")
        return
